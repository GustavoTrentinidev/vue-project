<template>
  <v-app>
    <v-app-bar app color="green accent-3" dark elevation="1">
    ...
    <v-navigation-drawer app v-model="sidebar" :mini-variant.sync="mini">
      <v-list elevation="1" dense color="green accent-3" dark>
        <v-list-item>
          <v-list-item-action>
      ...
      <v-list-item class="px-2" @click="mini = !mini">
        ...
        <v-list-item-content>Gustavo Trentini</v-list-item-content>
  ...
  data(){
    return {
      ...
      items: [
        ...
        {title: "Logout", icon: "mdi-exit-to-app", to: "/login"},
      ]
    }
  }
