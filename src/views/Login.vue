  ...
  <v-container fill-height fluid text-center>
        <v-container>
            ...
            <v-row class="elavation-3 mx-auto">
                <v-col cols="auto">
                    <v-img max-height="150" max-width="250" src="@/assets/images/firebase-logo.png"></v-img>
                </v-col>
                <v-col>
                    <v-form>
                        <v-text-field label="Email" v-model="user.email"></v-text-field>
                        <v-text-field label="Senha" @keydown.enter="login" v-model="user.password" 
        ...
        <v-dialog v-model="novaConta" persistent max-width='300'>
            <v-card>
                ...
                <v-card-text>
                    Deseja criar uma nova conta com os dados informados?
                </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
